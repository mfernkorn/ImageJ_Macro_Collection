...
for (i=0; i<list.length; i+=3) {
	...
	// Segmentation
	run("Command From Macro", "command=[de.csbdresden.stardist.StarDist2D], args=['input':'hoechst', 'modelChoice':'Versatile (fluorescent nuclei)', 'normalizeInput':'true', 'percentileBottom':'1.0', 'percentileTop':'99.8', 'probThresh':'0.7000000000000001', 'nmsThresh':'0.4', 'outputType':'Both', 'modelFile':'/Users/fernkorn/Desktop/2101_StardistModel_mes.zip', 'nTiles':'1', 'excludeBoundary':'2', 'roiPosition':'Automatic', 'verbose':'false', 'showCsbdeepProgress':'false', 'showProbAndDist':'false'], process=[false]");
	selectImage('hoechst');
	roiManager("Deselect");
